...
const newproject=async()=>{
    ...
    const res=await axios.get("https://bikeindex.org:443/api/v3/manufacturers/A2B e-bikes",config)
...
// const cal=async()=>{
//     const d=await newproject();
//     const price1=document.createElement('li');
